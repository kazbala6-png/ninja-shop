...
@bot.message_handler(func=lambda message: 'Адрес' in message.text or 'Доставка' in message.text or 'достовка' in message.text)
...
@bot.message_handler(func=lambda message: 'менеджер' in message.text.lower() or 'Написать' in message.text)
